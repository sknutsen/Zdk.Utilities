...
namespace Zdk.Utilities.Authentication.Pages.Account;
...
public class ExternalLoginModel : PageModel
{
    ...
    private ZdkUser CreateUser()
    {
        try
        {
            return Activator.CreateInstance<ZdkUser>();
        }
        catch
        {
            throw new InvalidOperationException($"Can't create an instance of '{nameof(ZdkUser)}'. " +
                $"Ensure that '{nameof(ZdkUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
